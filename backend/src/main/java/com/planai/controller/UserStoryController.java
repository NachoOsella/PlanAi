...
public class UserStoryController {
    ...
    public ResponseEntity<List<UserStoryResponse>> getEpicStories(@PathVariable Long epicId) {
    ...
    public ResponseEntity<UserStoryResponse> createStory(@PathVariable Long epicId,
    ...
    public ResponseEntity<UserStoryResponse> updateStory(@PathVariable Long id,
            @Valid @RequestBody CreateStoryRequest request) {
